...
class TestNLTool:
    ...
    def test_with_args_in_description(self, simple_tool: SimpleTool, mock_llm_client: MagicMock):
...
class TestToolWithFormatter:
    def test_name_and_input_type(self, simple_tool: SimpleTool, mock_llm_client: MagicMock):
